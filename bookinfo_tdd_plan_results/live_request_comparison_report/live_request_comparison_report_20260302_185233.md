# Verified Source vs 실요청 실측 비교 리포트 (2026-03-02 18:52:33 KST)
...
|---|---|---:|---|
| cleancode | online(fallback) (retry=1) | N/A | 요청 성공 |
...
| metadata.publisher | Addison-Wesley Professional | Pearson | ❌ |
| metadata.isbn13 | 978-0132350884 | 978-0-13-235088-4 | ✅ |
| table_of_contents.total_chapters | 17 | 17 | ✅ |
| table_of_contents.total_appendices | 3 | 3 | ✅ |
...
| metadata.isbn13_biology | 978-1506297408 | 9781506294124 | ❌ |
| metadata.isbn13_biochemistry | 978-1506297385 | 9781506294087 | ❌ |
...
## 산출물
- 상세 리포트: `/private/tmp/qwen-test/bookinfo_tdd_plan_results/live_request_comparison_report/live_request_comparison_report_20260302_185233.md`
- 원본 응답(raw): `/private/tmp/qwen-test/bookinfo_tdd_plan_results/live_request_comparison_report/live_request_raw_20260302_185233.json`
