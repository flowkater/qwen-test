# Verified Source vs 실요청 실측 비교 리포트 (2026-03-02 18:13:23 KST)
...
| 항목 | 기준값 | 실측값 | 결과 |
|---|---|---|---|
| metadata.publisher | Kaplan Test Prep | Kaplan Publishing | ❌ |
...
| key_lectures[1].title | 문법의 개념 | Real Deal Class - Zero to One - Unit 1 - 문법의개념 | ❌ |
...
## 산출물
- 상세 리포트: `/Users/flowkater/workspace/side/qwen/bookinfo_tdd_plan_results/live_request_comparison_report_20260302_181323.md`
- 원본 응답(raw): `/Users/flowkater/workspace/side/qwen/bookinfo_tdd_plan_results/live_request_raw_20260302_181323.json`
