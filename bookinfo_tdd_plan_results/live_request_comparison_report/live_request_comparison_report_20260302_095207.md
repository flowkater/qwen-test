# Verified Source vs 실요청 실측 비교 리포트 (2026-03-02 09:52:07 KST)
...
| inflearn | online(fallback) | N/A | 요청 성공 |
...
| metadata.isbn13 | 978-0132350884 | 978-0132350884 | ✅ |
...
| 항목 | 기준값 | 실측값 | 결과 |
|---|---|---|---|
| metadata.publisher | Kaplan Test Prep | Kaplan Test Prep | ✅ |
| metadata.isbn13_biology | 978-1506297408 | 9781506282954 | ❌ |
| metadata.isbn13_biochemistry | 978-1506297385 |  | ❌ |
| table_of_contents.biology_chapters | 8 | 12 | ❌ |
...
| 항목 | 기준값 | 실측값 | 결과 |
|---|---|---|---|
| metadata.platform | RealDealClass | Online | ❌ |
| metadata.difficulty | (왕)초급 - 초중급 | Beginner | ❌ |
| metadata.duration | 6개월 | 6 months | ❌ |
| curriculum.total_chapters | 7 | 0 | ❌ |
| curriculum.has_special_lessons | True | True | ✅ |
| curriculum.special_lesson_count | 5 | 1 | ❌ |
...
| key_lectures[1].title | 문법의 개념 | 문법의 개념 | ✅ |
...
## 산출물
- 상세 리포트: `/Users/flowkater/workspace/side/qwen/bookinfo_tdd_plan_results/live_request_comparison_report_20260302_095207.md`
- 원본 응답(raw): `/Users/flowkater/workspace/side/qwen/bookinfo_tdd_plan_results/live_request_raw_20260302_095207.json`
