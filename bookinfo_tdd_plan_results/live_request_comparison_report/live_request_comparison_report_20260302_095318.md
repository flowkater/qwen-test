# Verified Source vs 실요청 실측 비교 리포트 (2026-03-02 09:53:18 KST)

- 모델: `qwen/qwen3.5-flash-02-23`
- search_mode: `auto`
- prompt_mode: `soft-json`
- timeout: `120s`
...
| table_of_contents.total_appendices | 2 | 1 | ❌ |
...
| metadata.difficulty | (왕)초급 - 초중급 | 왕초보 (영어 아예 해본 적 없음) | ❌ |
| metadata.duration | 6개월 | 6 개월 | ❌ |
| curriculum.total_chapters | 7 | 0 | ❌ |
| curriculum.has_special_lessons | True | True | ✅ |
| curriculum.special_lesson_count | 5 | 4 | ❌ |
...
| key_lectures[1].title | 문법의 개념 | UNIT.1 - 개념 설명 | ❌ |
...
## 산출물
- 상세 리포트: `/Users/flowkater/workspace/side/qwen/bookinfo_tdd_plan_results/live_request_comparison_report_20260302_095318.md`
- 원본 응답(raw): `/Users/flowkater/workspace/side/qwen/bookinfo_tdd_plan_results/live_request_raw_20260302_095318.json`
