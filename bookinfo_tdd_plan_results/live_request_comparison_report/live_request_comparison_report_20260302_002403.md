# Verified Source vs 실요청 실측 비교 리포트 (2026-03-02 00:25:42 KST)
...
| metadata.publisher | Addison-Wesley Professional | Prentice Hall | ❌ |
...
| table_of_contents.biology_chapters | 8 | 0 | ❌ |
...
| 항목 | 기준값 | 실측값 | 결과 |
|---|---|---|---|
| metadata.instructor | mindlantern | 김태훈 | ❌ |
| metadata.platform | Inflearn | Inflearn | ✅ |
| metadata.rating | 4.9 | 4.9 | ✅ |
| metadata.total_lectures | 24 | 45 | ❌ |
| curriculum.total_sections | 4 | 6 | ❌ |
| curriculum.section_lecture_counts | [4, 6, 9, 5] | [2, 10, 12, 8, 7, 6] | ❌ |
...
| key_lectures[3.3].title | API Gateway & Load Balancer & Service Discovery | 캐싱 전략 - Write-Through vs Write-Back | ❌ |
| key_lectures[3.3].duration | 16:01 | 14:20 | ❌ |
| key_lectures[3.7].title | Message Queue & Event Broker | 캐싱 무결성 및 갱신 전략 | ❌ |
| key_lectures[3.7].duration | 32:12 | 11:50 | ❌ |
...
| 항목 | 기준값 | 실측값 | 결과 |
|---|---|---|---|
| metadata.platform | RealDealClass | 리얼딜 | ❌ |
| metadata.difficulty | (왕)초급 - 초중급 | 초급 | ❌ |
| metadata.duration | 6개월 | 미정 | ❌ |
...
## 산출물
- 상세 리포트: `/Users/flowkater/workspace/side/qwen/bookinfo_tdd_plan_results/live_request_comparison_report_20260302_002403.md`
- 원본 응답(raw): `/Users/flowkater/workspace/side/qwen/bookinfo_tdd_plan_results/live_request_raw_20260302_002403.json`